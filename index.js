...
var NewMessage_1 = require("telegram/events/NewMessage");
var input = require("input"); // npm i input
var apiId = 18500193;
var apiHash = "112c7055804f7008b849978bc73cb714";
var stringSession = new sessions_1.StringSession(""); // fill this later with the value from session.save()
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!event.isPrivate) return [3 /*break*/, 3];
                    ...
                    case 1:
                        ...
                        // @ts-ignore
                        if (sender.username == 'frntdev') {
                            console.log('is me');
                        }
                        return [4 /*yield*/, client.sendMessage("testflp", {
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, client.start({
                        phoneNumber: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, client.sendMessage("me", { message: "Hello!" })];
            case 3:
                _a.sent();
                // adds an event handler for new messages
                client.addEventHandler(eventPrint, new NewMessage_1.NewMessage({}));
                return [2 /*return*/];
        }
    });
}); })();
